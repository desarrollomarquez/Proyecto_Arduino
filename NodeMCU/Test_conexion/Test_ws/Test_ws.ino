...
const char* ssid = "Marquez Correa"; // Rellena con el nombre de tu red WiFi
const char* password = "Marquez8355196"; // Rellena con la contraseña de tu red WiFi

const char* host = "gateway.marvel.com";
const char* apiKey = "852bd3aedd0c550e2e412b99b70d7653"; // Puedes obtenerla en
...
Serial.print("connecting to ");
  ...
  String url = "/v1/public/characters?apikey=";
  url += apiKey;
